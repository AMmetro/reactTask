...
function Navigation() {
    ...
    return (
        <div>
            ...
            <section className={s.head}><h1>Home work</h1></section>
            ...
            <ul className={s.hidden_menu}>
                <li><NavLink onClick={() => selectActive("link1")} className={link_status1}
                             to="/pre-junior">Pre-junior </NavLink></li>
                <li><NavLink onClick={() => selectActive("link2")} className={link_status2}
                             to="/junior">Junior </NavLink></li>
                <li><NavLink onClick={() => selectActive("link3")} className={link_status3}
                             to="/juniorPlus">JuniorPlus </NavLink></li>
            </ul>
